    ...
    <div className="h-screen overflow-y-auto flex flex-col ml-36 mr-20 pb-10 mt-10">
      ...
      <div className="flex flex-row mt-20">
        <Link
          ...
          style={{ color: settings.appearance.customThemes[settings.appearance.theme].text2 }}
        >
          <GoBack
            style={{ fill: settings.appearance.customThemes[settings.appearance.theme].text2 }}
            className="w-4 h-4"
          />
          Back to Templates
        </Link>
      ...
      <div className="mt-12 flex flex-col gap-10 lg:flex-row lg:gap-20 items-start">
        ...
        <div className="flex flex-col gap-6 min-w-[260px]">
          <div>
            <div
              ...
              style={{ color: settings.appearance.customThemes[settings.appearance.theme].text1 }}
            >
              {title}
            </div>
            <div
              className="mt-3 text-sm font-inter font-light leading-relaxed max-w-xs"
              style={{ color: settings.appearance.customThemes[settings.appearance.theme].text3 }}
            >
              Standard formatting with pre-structured sections. Click "Select Template" to customise project details.
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 w-fit">
            <Link to={`/detailPage/${templateKey}`}>
              <div className="relative text-[#AB2D2D] text-base font-inter font-normal text-nowrap border-[#AB2D2D] pl-10 pt-[1vh] pb-[0.7vh] pr-8 border-[1px]">
                <span className="absolute left-4 font-playfair top-0 text-2xl">+</span>
                Select Template
              </div>
            </Link>
            <Link to="/template">
              <div
                ...
                style={{
                  color: settings.appearance.customThemes[settings.appearance.theme].text2,
                  borderColor: settings.appearance.customThemes[settings.appearance.theme].text2,
                }}
              >
        ...
        <div
          ...
          style={{ borderColor: settings.appearance.customThemes[settings.appearance.theme].text3 + "40", background: settings.appearance.customThemes[settings.appearance.theme].text3 + "08" }}
        >
          <div className="text-center opacity-40">
            ...
            <p className="text-xs font-inter opacity-60">templates/{templateKey}/preview.png</p>
          </div>
        </div>
      </div>
    </div>
