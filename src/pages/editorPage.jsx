...
import RichTextEditorPanel from "../components/textEditor"; // Restored
import SlateEditorPanel from "../components/slateEditor";
import SectionEditor from "../components/sectionEditor.jsx";
import LeaveSession from "../components/LeaveSession.jsx";
import { compileDocument, api } from "../api/projectHandling";
...
const EditorPage = () => {
  ...
  useEffect(() => {
    const fetchCollabToken = async () => {
      ...
      try {
        // const apiBase = import.meta.env.VITE_admin_server;
        ...
        const response = await api.post(
          `
          /api/projects/${projectId}/get-collab-token`,
          {},
        );
   ...
   * Slate calls this with a new AST. It:
  ...
  // Legacy String-based Rich Text Handler (ReactQuill)
  ...
  // New AST-based Rich Text Handler (Slate)
