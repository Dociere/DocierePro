...
const StatusBar = () => {
  ...
  return (
    <>
      <div className={`w-screen z-30 h-5 fixed bottom-0 border-[1.5px] transition-colors duration-300 ${isDark ? 'bg-[#252525] border-[#404040]' : 'bg-[#F9F9F9] border-[#CFCFCF]'
        }`}>
        <div className={`flex flex-row justify-between mx-5 text-[13px] transition-colors ${isDark ? 'text-[#a0a0a0]' : 'text-[#9095A1]'
          }`}>
