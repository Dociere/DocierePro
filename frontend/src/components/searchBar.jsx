...
const SearchBar = () => {
  ...
  return (
    <div className="relative w-[45vw] ml-64 mt-2">
      <div className="group flex items-center relative">
        ...
        <input
          ...
          className="w-full h-7 text-sm font-inter pl-6 pr-12 text-[gray-800] bg-[#F9F9F9] border-solid border-2 border-[#CFCFCF] outline-none transition duration-300 placeholder:text-[#656565]"
        />
        {query && (
          <button
            onClick={handleClear}
        ...
        {!isActive && !query && (
          <div className="absolute text-xs right-3 font-thin text-[#666666] cursor-pointer px-3 py-1 font-mono tracking-tighter">
            ctrl + /
          </div>
        )}
      </div>
